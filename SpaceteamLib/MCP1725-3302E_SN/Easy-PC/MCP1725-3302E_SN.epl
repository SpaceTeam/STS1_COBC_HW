...
(library Library_1
	...
	(compDef "MCP1725-3302E_SN" (originalName "MCP1725-3302E_SN") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "8" (pinName "VOUT") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "SENSE") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "CDELAY") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "PWRGD") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://ww1.microchip.com/downloads/en/DeviceDoc/22026b.pdf")
		(attr "Height" "1.75 mm")
	)
